...
/* harmony import */ var _utils_wrappedDist__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utils/wrappedDist */ "./src/typeedit/utils/wrappedDist.ts");
var __spreadArrays = (undefined && undefined.__spreadArrays) || function () {
    for (var s = 0, i = 0, il = arguments.length; i < il; i++) s += arguments[i].length;
    for (var r = Array(s), k = 0, i = 0; i < il; i++)
        for (var a = arguments[i], j = 0, jl = a.length; j < jl; j++, k++)
...
var Viewport = /** @class */ (function () {
    ...
    Viewport.prototype.restrictAngles = function (start, pos, e) {
        var angles = [
            _app__WEBPACK_IMPORTED_MODULE_7__["currentFont"].settings.constructionAngle0,
            _app__WEBPACK_IMPORTED_MODULE_7__["currentFont"].settings.constructionAngle1,
            _app__WEBPACK_IMPORTED_MODULE_7__["currentFont"].settings.constructionAngle2,
            _app__WEBPACK_IMPORTED_MODULE_7__["currentFont"].settings.constructionAngle3
        ];
        ...
        if (e.shiftKey &&
            ...
            var angleDists = angles.map(function (a) { return Object(_utils_wrappedDist__WEBPACK_IMPORTED_MODULE_8__["wrappedDist"])(nrmAngle_1, a, 180); });

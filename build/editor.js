...
var BezierCurve = /** @class */ (function (_super) {
    ...
    BezierCurve.prototype.simplify = function () {
        var _this = this;
        var out = [];
        for (var i = 0; i < this.points.length; i++) {
            ...
            if (point.base.distance(next.base) < 0.001) {
                if (point.after.distance(point.base) < 0.001 &&
                    next.before.distance(next.base) < 0.001) {
                    out.push(new _point__WEBPACK_IMPORTED_MODULE_1__["BezierPoint"](point.base, point.before, next.after));
                    i++;
                }
            }
            else {
...
(function (BezierPointType) {
    ...
    BezierPointType[BezierPointType["forward"] = 3] = "forward";
    BezierPointType[BezierPointType["backward"] = 4] = "backward";
...
var BezierPoint = /** @class */ (function (_super) {
    ...
    function BezierPoint(base, before, after, type) {
        if (type === void 0) { type = BezierPointType.free; }
        var _this = _super.call(this) || this;
        _this.base = base;
        _this.before = before;
        _this.after = after;
    ...
    Object.defineProperty(BezierPoint.prototype, "previous", {
        get: function () {
            if (!this.curve)
                return;
            var index = this.curve.points.indexOf(this);
            if (index === 0)
    ...
    Object.defineProperty(BezierPoint.prototype, "next", {
        get: function () {
            if (!this.curve)
                return;
            var index = this.curve.points.indexOf(this);
            return this.curve.points[(index + 1) % this.curve.points.length];
        },
        enumerable: false,
        configurable: true
    });
    ...
    BezierPoint.prototype.determineType = function () {
        ...
        else if (radius1 < 0.001 && radius2 > 0.001 &&
            next.before.distance(next.base) < 0.001 &&
            Math.abs(angle2 - this.base.angle(next.base)) < 0.001) {
            this.type = BezierPointType.backward;
            return;
        }
        else if (radius1 > 0.001 && radius2 < 0.001 &&
            prev.after.distance(prev.base) < 0.001 &&
            Math.abs(angle1 - this.base.angle(prev.base)) < 0.001) {
            this.type = BezierPointType.forward;
            return;
        }
        var angleDiff = Math.abs(angle1 - angle2);
        if (Math.abs(angleDiff - Math.PI) < 0.001)
...
/***/ "./src/typeedit/ui/panel/controls/accordion.ts":
/*!*****************************************************!*\
  !*** ./src/typeedit/ui/panel/controls/accordion.ts ***!
  \*****************************************************/
/*! exports provided: default */
...
function Accordion(name, headerItems, content) {
    var div = document.createElement("div");
    div.className = "accordion";
    var header = document.createElement("header");
    header.textContent = name;
    headerItems.forEach(function (i) { return header.appendChild(i); });
    div.appendChild(header);
    var contentDiv = document.createElement("div");
    contentDiv.className = "content";
    content.forEach(function (i) { return contentDiv.appendChild(i); });
...
/***/ "./src/typeedit/ui/panel/controls/buttonGroup.ts":
/*!*******************************************************!*\
  !*** ./src/typeedit/ui/panel/controls/buttonGroup.ts ***!
  \*******************************************************/
/*! exports provided: default */
...
function ButtonGroup(buttons) {
    ...
    buttons.forEach(function (b) { return div.appendChild(b); });
    return div;
}
...
/***/ "./src/typeedit/ui/panel/controls/checkbox.ts":
/*!****************************************************!*\
  !*** ./src/typeedit/ui/panel/controls/checkbox.ts ***!
  \****************************************************/
/*! exports provided: default */
...
function Checkbox(get, toggle, update) {
...
/***/ "./src/typeedit/ui/panel/controls/grid.ts":
/*!************************************************!*\
  !*** ./src/typeedit/ui/panel/controls/grid.ts ***!
  \************************************************/
/*! exports provided: default */
...
/***/ "./src/typeedit/ui/panel/controls/label.ts":
/*!*************************************************!*\
  !*** ./src/typeedit/ui/panel/controls/label.ts ***!
  \*************************************************/
/*! exports provided: default */
...
/***/ "./src/typeedit/ui/panel/controls/numberInput.ts":
/*!*******************************************************!*\
  !*** ./src/typeedit/ui/panel/controls/numberInput.ts ***!
  \*******************************************************/
/*! exports provided: default */
...
function NumberInput(get, set, update, min, max, step) {
    if (min === void 0) { min = 0; }
    if (max === void 0) { max = 0; }
...
/***/ "./src/typeedit/ui/panel/controls/row.ts":
/*!***********************************************!*\
  !*** ./src/typeedit/ui/panel/controls/row.ts ***!
  \***********************************************/
/*! exports provided: default */
...
function ToggleButton(icon, get, toggle, update) {
    var button = document.createElement("button");
    if (icon) {
        var img = new Image();
...
/***/ "./src/typeedit/ui/panel/snapping.ts":
/*!*******************************************!*\
  !*** ./src/typeedit/ui/panel/snapping.ts ***!
  \*******************************************/
/*! exports provided: prepareSnappingPanel */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "prepareSnappingPanel", function() { return prepareSnappingPanel; });
/* harmony import */ var _controls_accordion__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./controls/accordion */ "./src/typeedit/ui/panel/controls/accordion.ts");
/* harmony import */ var _controls_buttonGroup__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./controls/buttonGroup */ "./src/typeedit/ui/panel/controls/buttonGroup.ts");
/* harmony import */ var _controls_checkbox__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./controls/checkbox */ "./src/typeedit/ui/panel/controls/checkbox.ts");
/* harmony import */ var _controls_grid__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./controls/grid */ "./src/typeedit/ui/panel/controls/grid.ts");
/* harmony import */ var _controls_label__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./controls/label */ "./src/typeedit/ui/panel/controls/label.ts");
/* harmony import */ var _controls_numberInput__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./controls/numberInput */ "./src/typeedit/ui/panel/controls/numberInput.ts");
/* harmony import */ var _controls_row__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./controls/row */ "./src/typeedit/ui/panel/controls/row.ts");
/* harmony import */ var _controls_toggleButton__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./controls/toggleButton */ "./src/typeedit/ui/panel/controls/toggleButton.ts");
...
function prepareSnappingPanel(font) {
    var panel = document.querySelector("div.panelContents[data-tab=snapping]");
    var snappingSection = Object(_controls_accordion__WEBPACK_IMPORTED_MODULE_0__["default"])("Snapping", [], [
        Object(_controls_buttonGroup__WEBPACK_IMPORTED_MODULE_1__["default"])([
            Object(_controls_toggleButton__WEBPACK_IMPORTED_MODULE_7__["default"])("curvesnap", function () { return font.settings.curveSnapEnabled; }, function () {
                font.settings.curveSnapEnabled = !font.settings.curveSnapEnabled;
            }, function (h) {
                font.on("settingChanged", function (k) {
                    if (k === "curveSnapEnabled")
                        h(font.settings.curveSnapEnabled);
                });
            }),
            Object(_controls_toggleButton__WEBPACK_IMPORTED_MODULE_7__["default"])("handlesnap", function () { return font.settings.handleSnapEnabled; }, function () {
            ...
            Object(_controls_toggleButton__WEBPACK_IMPORTED_MODULE_7__["default"])("metricsnap", function () { return font.settings.metricsSnapEnabled; }, function () {
    ...
    var gridSection = Object(_controls_accordion__WEBPACK_IMPORTED_MODULE_0__["default"])("Grid", [
        Object(_controls_checkbox__WEBPACK_IMPORTED_MODULE_2__["default"])(function () { return font.settings.gridEnabled; }, function () {
        ...
        Object(_controls_grid__WEBPACK_IMPORTED_MODULE_3__["default"])([
            Object(_controls_row__WEBPACK_IMPORTED_MODULE_6__["default"])([
                Object(_controls_label__WEBPACK_IMPORTED_MODULE_4__["default"])("Size:"),
                Object(_controls_numberInput__WEBPACK_IMPORTED_MODULE_5__["default"])(function () { return font.settings.gridMainGap; }, function (v) {
            ...
            Object(_controls_row__WEBPACK_IMPORTED_MODULE_6__["default"])([
                Object(_controls_label__WEBPACK_IMPORTED_MODULE_4__["default"])("Div:"),
                Object(_controls_numberInput__WEBPACK_IMPORTED_MODULE_5__["default"])(function () { return font.settings.gridSubdivisions; }, function (v) {
    ...
    var constructionSection = Object(_controls_accordion__WEBPACK_IMPORTED_MODULE_0__["default"])("Construction angles", [
        Object(_controls_checkbox__WEBPACK_IMPORTED_MODULE_2__["default"])(function () { return font.settings.constructionEnabled; }, function () {
        ...
        Object(_controls_grid__WEBPACK_IMPORTED_MODULE_3__["default"])([
            Object(_controls_numberInput__WEBPACK_IMPORTED_MODULE_5__["default"])(function () { return font.settings.constructionAngle0; }, function (v) {
            ...
            Object(_controls_numberInput__WEBPACK_IMPORTED_MODULE_5__["default"])(function () { return font.settings.constructionAngle1; }, function (v) {
            ...
            Object(_controls_numberInput__WEBPACK_IMPORTED_MODULE_5__["default"])(function () { return font.settings.constructionAngle2; }, function (v) {
            ...
            Object(_controls_numberInput__WEBPACK_IMPORTED_MODULE_5__["default"])(function () { return font.settings.constructionAngle3; }, function (v) {
...
/***/ "./src/typeedit/utils/wrappedDist.ts":
/*!*******************************************!*\
  !*** ./src/typeedit/utils/wrappedDist.ts ***!
  \*******************************************/
/*! exports provided: wrappedDist */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "wrappedDist", function() { return wrappedDist; });
function wrappedDist(x, y, max) {
    var extraX = (x > max / 2) ? (x - max) : (x + max);
    return Math.min(Math.abs(x - y), Math.abs(extraX - y));
}
...
var BezierBasePointHandle = /** @class */ (function () {
    ...
    BezierBasePointHandle.prototype.render = function (v, ctx) {
        ...
        var angle2 = this.point.before.angle(this.point.base);
        ctx.beginPath();
        switch (this.point.type) {
            case _geometry_bezier_point__WEBPACK_IMPORTED_MODULE_0__["BezierPointType"].auto:
                ctx.moveTo(6 * Math.cos(angle), 6 * Math.sin(angle));
                ctx.lineTo(6 * Math.cos(angle + Math.PI / 2), 6 * Math.sin(angle + Math.PI / 2));
                ctx.lineTo(6 * Math.cos(angle + Math.PI), 6 * Math.sin(angle + Math.PI));
                ctx.lineTo(6 * Math.cos(angle + 3 * Math.PI / 2), 6 * Math.sin(angle + 3 * Math.PI / 2));
                break;
            case _geometry_bezier_point__WEBPACK_IMPORTED_MODULE_0__["BezierPointType"].forward:
                ctx.moveTo(7 * Math.cos(angle), 7 * Math.sin(angle));
                ctx.lineTo(7 * Math.cos(angle + Math.PI / 2), 7 * Math.sin(angle + Math.PI / 2));
                ctx.lineTo(7 * Math.cos(angle + 3 * Math.PI / 2), 7 * Math.sin(angle + 3 * Math.PI / 2));
                break;
            case _geometry_bezier_point__WEBPACK_IMPORTED_MODULE_0__["BezierPointType"].backward:
                ctx.moveTo(7 * Math.cos(angle2), 7 * Math.sin(angle2));
                ctx.lineTo(7 * Math.cos(angle2 + Math.PI / 2), 7 * Math.sin(angle2 + Math.PI / 2));
                ctx.lineTo(7 * Math.cos(angle2 + 3 * Math.PI / 2), 7 * Math.sin(angle2 + 3 * Math.PI / 2));
                break;
        ...
        ctx.closePath();
        var fillColor = Object(_ui_theme__WEBPACK_IMPORTED_MODULE_2__["getThemeColor"])("handleFreeFill");
        if (this.point.type === _geometry_bezier_point__WEBPACK_IMPORTED_MODULE_0__["BezierPointType"].auto)
            fillColor = Object(_ui_theme__WEBPACK_IMPORTED_MODULE_2__["getThemeColor"])("handleAutoFill");
        else if (this.point.type === _geometry_bezier_point__WEBPACK_IMPORTED_MODULE_0__["BezierPointType"].sharp)
            fillColor = Object(_ui_theme__WEBPACK_IMPORTED_MODULE_2__["getThemeColor"])("handleSharpFill");
        else if (this.point.type === _geometry_bezier_point__WEBPACK_IMPORTED_MODULE_0__["BezierPointType"].forward ||
            this.point.type === _geometry_bezier_point__WEBPACK_IMPORTED_MODULE_0__["BezierPointType"].backward)
            fillColor = Object(_ui_theme__WEBPACK_IMPORTED_MODULE_2__["getThemeColor"])("handleDirFill");
    ...
    Object.defineProperty(FontMetricHandle.prototype, "position", {
        get: function () {
            if (this.dir === FontMetricHandleDir.horz)
                return new _geometry_point__WEBPACK_IMPORTED_MODULE_0__["Point"](this.glyph.metrics.leftBearing - 20, this.value);
...
/* harmony import */ var _geometry_point__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../geometry/point */ "./src/typeedit/geometry/point.ts");
/* harmony import */ var _coordinates__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./coordinates */ "./src/typeedit/viewport/coordinates.ts");
...
/* harmony import */ var _guides_point__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./guides/point */ "./src/typeedit/viewport/guides/point.ts");
...
/* harmony import */ var _utils_accelerator__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../utils/accelerator */ "./src/typeedit/utils/accelerator.ts");
...
var Viewport = /** @class */ (function () {
    function Viewport(context, handles, tool) {
        ...
        this.constructionAngle = 0;
        this.constructionReference = new _geometry_point__WEBPACK_IMPORTED_MODULE_0__["Point"]();
    ...
    Viewport.prototype.setupCanvasEvents = function () {
        ...
        this.domCanvas.addEventListener("contextmenu", function () {
                    ...
                    menuItems.push({
                        ...
                        submenu: section.subactions.map(function (a) {
                            return {
                                ...
                                accelerator: Object(_utils_accelerator__WEBPACK_IMPORTED_MODULE_7__["accelStringToElectron"])(a.accelerator)
                            };
                        })
                    });
                }
            ...
            var menu = electron__WEBPACK_IMPORTED_MODULE_6__["remote"].Menu.buildFromTemplate(menuItems);
            menu.popup();
        });
    ...
    Viewport.prototype.nudgePoint = function (pos, obj) {
        ...
        this.nudgeToGuides(pos, obj, guides.filter(function (g) { return g instanceof _guides_curve__WEBPACK_IMPORTED_MODULE_2__["CurveGuide"]; }));
        if (_app__WEBPACK_IMPORTED_MODULE_8__["currentFont"].settings.gridEnabled)
            this.nudgeToGuides(pos, obj, this.context.grids);
        this.nudgeToGuides(pos, obj, guides.filter(function (g) { return g instanceof _guides_line__WEBPACK_IMPORTED_MODULE_4__["HorizontalGuide"] ||
            g instanceof _guides_line__WEBPACK_IMPORTED_MODULE_4__["VerticalGuide"]; }), false);
        this.nudgeToGuides(pos, obj, guides.filter(function (g) { return g instanceof _guides_point__WEBPACK_IMPORTED_MODULE_5__["PointGuide"]; }));
    };
    Viewport.prototype.restrictAngles = function (start, pos, e) {
        var angles = [
            _app__WEBPACK_IMPORTED_MODULE_8__["currentFont"].settings.constructionAngle0,
            _app__WEBPACK_IMPORTED_MODULE_8__["currentFont"].settings.constructionAngle1,
            _app__WEBPACK_IMPORTED_MODULE_8__["currentFont"].settings.constructionAngle2,
            _app__WEBPACK_IMPORTED_MODULE_8__["currentFont"].settings.constructionAngle3
        ];
        var r = pos.distance(start);
        var angle = pos.angle(start);
        this.isConstructing = false;
        if (e.shiftKey &&
            _app__WEBPACK_IMPORTED_MODULE_8__["currentFont"].settings.constructionEnabled) {
            var add180 = false;
            var nrmAngle_1 = angle * (180 / Math.PI);
            if (nrmAngle_1 < 0) {
                nrmAngle_1 = 180 + nrmAngle_1;
                add180 = true;
            }
            var angleDists = angles.map(function (a) { return Object(_utils_wrappedDist__WEBPACK_IMPORTED_MODULE_9__["wrappedDist"])(nrmAngle_1, a, 180); });
            var minIndex = angleDists.indexOf(Math.min.apply(Math, angleDists));
            var selectedAngle = angles[minIndex];
            if (Math.abs(angle * (180 / Math.PI) - selectedAngle) > 90) {
                selectedAngle += 180;
            }
            var finalAngle = selectedAngle * (Math.PI / 180);
    ...
    Viewport.prototype.render = function () {
        ...
        if (this.isConstructing) {
            ...
            this.ctx.beginPath();
            this.ctx.moveTo(clientConstr.x - 1000 * Math.cos(this.constructionAngle), clientConstr.y - 1000 * Math.sin(this.constructionAngle));
            this.ctx.lineTo(clientConstr.x + 1000 * Math.cos(this.constructionAngle), clientConstr.y + 1000 * Math.sin(this.constructionAngle));
            this.ctx.stroke();
        }
